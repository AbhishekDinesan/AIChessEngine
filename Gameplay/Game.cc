...
Game::Game(AbstractPlayer *white, AbstractPlayer *black, bool whiteToMove, bool customProvided, Board *theCustomBoard) : whitePlayer{white}, blackPlayer{black}, moveCount{0}, whiteToMove{whiteToMove}, board{theCustomBoard}
{
    if (!customProvided)
    {
